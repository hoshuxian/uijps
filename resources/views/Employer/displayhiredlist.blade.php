...
<tbody>
  ...
  <td>{{$detaa->std_matric}}</td>
    ...
    <td><a href="/offerprofile/{{$detaa->post_id}}/{{ $detaa->id}}"><button type="button" style="background-color: white; border: 1px solid white;" > <ion-icon name="eye-outline"></ion-icon></button></a></td>
  </tr>
  @endforeach
</tbody>
      </table>
