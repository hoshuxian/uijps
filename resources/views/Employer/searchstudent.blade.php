...
@foreach($deta as $detaa)
  ...
  <td>{{$detaa->std_matric}}</td>
    ...
    <td><a href="/displaystudentprofile/{{ $detaa->id}}"><button type="button" style="background-color: white; border: 1px solid white;" > <ion-icon name="eye-outline"></ion-icon></button></a></td>
  </tr>
  @endforeach
</tbody>
      </table>
