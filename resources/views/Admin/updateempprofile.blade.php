...
<form action='/updateempprofile' method='POST'>
  ...
  <img src="{{$detaa->company_logo}}"style="width:150px;height:150px; float:left;border-radius:50%;margin-right:25px;border;" name ="image" required>
    ...
    <div class="input-box">
        <span class="details" style="margin-left: 24%;">Background picture: </span>
        <input style="border:transparent;margin-top:10px;" type ="file" name="background" value="{{ $detaa->company_backgroundpic}}">
      </div>
...
@endif
    ...
    <a href='/displayempprofile/{{$detaa->reg_no}}' type="button "value="Back" class="button" style="padding: 0.5rem 1.5rem;">BACK</a>
    @endforeach
  </form>
</div>
