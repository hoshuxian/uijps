...
<div class=search2>
    <form action="/searchevent/search" method="GET" role="search">
        <div class="input-group">
            ...
            <a href="/searchevent">&emsp;<button  class="refreshbtn" type="button" title="Refresh page"><ion-icon name="repeat-outline"></ion-icon></button></a>
        </div>
                    @if(!empty($successMsg))
...
<br><br>
<a href="createevent" class=" mt-1">
<input type="submit" name="new" value="Create New Event"></a>
<br><br><br>
</div>
