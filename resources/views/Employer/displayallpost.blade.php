...
@endif
<br>
<form action='/searchallpost' method='get'enctype="multipart/form-data">
@csrf
<p style="color:red;font-size: 30px;margin-left: 60%;margin-top:-10%;">{{$detaa->job_salary}}</p>
...
<button type="submit" class="button" value="back" style="margin-left:70%;"> BACK</button>
