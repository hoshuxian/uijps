...
<div class=search2>
    <form action="/searchcompany/search" method="GET" role="search">
        <div class="input-group">
            ...
            <a href="/searchcompany">&emsp;<button  class="refreshbtn" type="button" title="Refresh page"><ion-icon name="repeat-outline"></ion-icon></button></a>
        </div>
                    @if(!empty($successMsg))
...
@foreach($deta as $detaa)
  ...
  <td>{{$detaa->reg_no}}</td>
    ...
    <td><a href="/displaycompanyprofile/{{ $detaa->reg_no}}"><button type="button" style="background-color: white; border: 1px solid white;" > <ion-icon name="eye-outline"></ion-icon></button></a></td>
  </tr>
  @endforeach
</tbody>
      </table>
