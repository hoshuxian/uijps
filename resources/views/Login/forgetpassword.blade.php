  ...
  <div class="owl">
      ...
      <div class="container">
        <div class="user login">
          ...
          <div class="form-box">
            <form action='tryreset' id="resetpasswordform"method='post'enctype="multipart/form-data">
              @csrf
              ...
              <h2>Hello Again!</h2>
                ...
                <div class="input-icons"> 
                  <br>
                  <div class="input-icons"> 
                  <input id="email" placeholder="Enter your register email address" type="email" name="email" required><i class="fa fa-envelope iconss"></i></input>
</div>
                </div>
