...
<div class=search2>
    <form action="/searchjob/search" method="GET" role="search">
        <div class="input-group">
            ...
            <a href="/searchjob">&emsp;<button  class="refreshbtn" type="button" title="Refresh page"><ion-icon name="repeat-outline"></ion-icon></button></a>
        </div>
                    @if(!empty($successMsg))
...
<a href="/displayjob/{{ $detaa->post_id}}"><div class="container3">
