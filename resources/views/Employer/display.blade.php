...
<form action='/hired/{{$detaa->post_id}}/{{$detaa->id}}' method='POST'enctype="multipart/form-data" id="my-form">
...
<br><br>
@if(!empty($disable))
<button type="submit" class="button" value="hired" style="margin-left:70%;" id="mySubmit" onclick="myFunction()"> Offer</button>
@endif

@if(empty($disable))
<button type="submit" class="button" value="hired" style="margin-left:65%;" id="mySubmit"> Offer</button>
@endif
